...
export function ShopClientPage({ id }: { id: string }) {
  ...
  if (!shopDetails) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#0A0A0A] text-white p-4">
        <div className="text-center max-w-md mx-auto px-10 py-14 bg-[#0F0F0F] border border-white/10 rounded-xl shadow-2xl backdrop-blur-lg">
          <div className="inline-block p-2 mb-6 rounded-full bg-white/5">
            <svg
        ...
        <div className="container max-w-5xl mx-auto px-6 pt-16 pb-24">
          <header className="flex flex-col items-center mb-20">
              ...
              <div className="mb-8 relative">
                ...
                <div className="relative rounded-full p-1 bg-gradient-to-r from-white/20 via-white/30 to-white/20">
                  <img
                    ...
                    className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border border-black/60"
                  />
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="text-sm uppercase tracking-[0.3em] text-white/60 font-medium">
                Workshop Collection
              </div>
              <div className="h-px w-12 bg-white/20"></div>
            </div>
          ...
          <section className="relative">
            ...
            <div className="relative">
              ...
              {isWorkshopsLoading ? (
                  ...
                  {[...Array(3)].map((_, index) => (
                    ...
                    >
                      <div className="animate-pulse">
                        ...
                        <div className="h-10 bg-white/10 rounded mt-6 w-full"></div>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col items-center justify-center py-20 px-8 bg-white/[0.02] border border-white/10 rounded-xl">
